...
def test_error_handling():
    ...
    try:
        ...
        # Provide dummy UI attributes so _on_install_complete can run headlessly
        checker.progress_bar = Mock()
        checker.progress_var = Mock()

        # Stub message boxes to avoid blocking headless test runs
