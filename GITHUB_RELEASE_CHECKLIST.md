...
```
File: PGLOK-Linux-v0.1.4.tar.gz
Size: 58MB
...
```
File: PGLOK-v0.1.4-source.tar.gz
Size: 280KB
...
- ✅ **Version number helps** with identification
...
### 2. Fill Release Form
- **Tag version**: `v0.1.4`
- **Release title**: `PGLOK v0.1.4`
- **Target**: `main`
- **Description**: Copy from `RELEASE_NOTES.md`

### 3. Upload Assets
Click "Attach files" and upload:
1. `PGLOK-Linux-v0.1.4.tar.gz` (58MB)
2. `PGLOK-v0.1.4-source.tar.gz` (280KB)
...
```bash
# Install v0.1.3 somewhere else
./start_linux.sh
# Should auto-update to v0.1.4
```
...
3. **Downloads**: The matching asset (PGLOK-Linux-v0.1.4.tar.gz)
...
- [ ] Asset 1: PGLOK-Linux-v0.1.4.tar.gz (58MB)
- [ ] Asset 2: PGLOK-v0.1.4-source.tar.gz (280KB)
- [ ] Click: "Publish release"
